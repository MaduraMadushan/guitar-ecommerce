            ...
            <UserLayout>
                <div>
                    ...
                    <form onSubmit={(event) => this.submitForm(event)}>
                        ...
                        : null}
                        <button disabled={this.state.formSuccess} onClick={(event) => this.submitForm(event)}>
                        Add Product
                        </button>
                    </form>
                </div>
...
export default connect(mapStateToProps, {getBrands, getWoods, addProduct, clearProduct})(AddProduct);